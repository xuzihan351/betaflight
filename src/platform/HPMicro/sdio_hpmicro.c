...
static SD_nonblock_transfer_t nonblock_param;
...
static const sdioHardware_t sdioPinHardware[SDIODEV_COUNT] = {
    ...
    [SDIODEV_1] = {
        ...
        .sdioPinD0  = { PINDEF(PA1,  IOC_PA01_FUNC_CTL_SDC0_DATA_0), PINDEF(PA12, IOC_PA12_FUNC_CTL_SDC0_DATA_0) },
        .sdioPinD1  = { PINDEF(PA0,  IOC_PA00_FUNC_CTL_SDC0_DATA_1), PINDEF(PA13, IOC_PA13_FUNC_CTL_SDC0_DATA_1) },
        .sdioPinD2  = { PINDEF(PA5,  IOC_PA05_FUNC_CTL_SDC0_DATA_2), PINDEF(PA8,  IOC_PA08_FUNC_CTL_SDC0_DATA_2) },
        .sdioPinD3  = { PINDEF(PA4,  IOC_PA04_FUNC_CTL_SDC0_DATA_3), PINDEF(PA9,  IOC_PA09_FUNC_CTL_SDC0_DATA_3) },
    },
    ...
    [SDIODEV_1] = {
        ...
        .sdioPinD0  = { PINDEF(PE9,  IOC_PE09_FUNC_CTL_SDC0_DATA_0), PINDEF(PE26, IOC_PE26_FUNC_CTL_SDC0_DATA_0) },
        .sdioPinD1  = { PINDEF(PE8,  IOC_PE08_FUNC_CTL_SDC0_DATA_1), PINDEF(PE21, IOC_PE21_FUNC_CTL_SDC0_DATA_1) },
        .sdioPinD2  = { PINDEF(PE13, IOC_PE13_FUNC_CTL_SDC0_DATA_2), PINDEF(PE28, IOC_PE28_FUNC_CTL_SDC0_DATA_2) },
        .sdioPinD3  = { PINDEF(PE12, IOC_PE12_FUNC_CTL_SDC0_DATA_3), PINDEF(PE23, IOC_PE23_FUNC_CTL_SDC0_DATA_3) },
    },
    [SDIODEV_2] = {
        .instance = HPM_SDXC1,
        .irqn = IRQn_SDXC1,
...
SD_Error_t SD_ReadBlocks_DMA(uint64_t ReadAddress, uint32_t *buffer, uint32_t BlockSize, uint32_t NumberOfBlocks)
{
    ...
    SD_Handle.RXCplt = 1;
    hpm_stat_t status;
    if ((status = sd_start_read_blocks(&g_sd, (uint8_t *)buffer, ReadAddress, NumberOfBlocks, sdTransferCallback, &nonblock_param)) != status_success) {
        SD_Handle.RXCplt = 0;
        return SD_ERROR;
    }
...
SD_Error_t SD_WriteBlocks_DMA(uint64_t WriteAddress, uint32_t *buffer, uint32_t BlockSize, uint32_t NumberOfBlocks)
{
    ...
    SD_Handle.TXCplt = 1;
    hpm_stat_t status;
    if ((status = sd_start_write_blocks(&g_sd, (uint8_t *)buffer, WriteAddress, NumberOfBlocks, sdTransferCallback, &nonblock_param)) != status_success) {
        SD_Handle.TXCplt = 0;
        return SD_ERROR;
    }
