...
# ---- HIL (Hardware-in-the-Loop) test firmware ----
# Build with:  make TARGET=HPM6360 CONFIG=SK_FLYCONTROL_BF HIL_TEST=1
ifdef HIL_TEST
MCU_EXCLUDES += main.c
endif
...
MCU_COMMON_SRC := $(MCU_COMMON_SRC) \
            ...
            hil_test_i2c.c
VPATH           := $(VPATH):$(ROOT)/src/platform/HPMicro/hil_test
INCLUDE_DIRS    := $(INCLUDE_DIRS) \
                   $(ROOT)/src/platform/HPMicro/hil_test
endif
